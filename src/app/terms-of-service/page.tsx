        ...
        <div className="container mx-auto px-6 py-20 text-gray-800 dark:text-gray-200">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                We are Pawdopt (&quot;Company,&quot; &quot;we,&quot;
                &quot;us,&quot; &quot;our&quot;), a company registered in
                California, United States at 1150 South Olive Street, Los
                Angeles, CA 90015.
              </p>
              <p>
                We operate the website{" "}
                <a
                  href="http://www.pawdopt.app"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  http://www.pawdopt.app
                </a>{" "}
                (the &quot;Site&quot;), the mobile application Pawdopt (the
              ...
              <p>
                Pawdopt (&quot;the App,&quot; &quot;our Service&quot;) is a
                mobile application designed to help users discover and connect
                with adoptable pets from shelters and rescue organizations. Our
                Service provides a modern, video-centric platform where users
                can browse animal profiles, view videos to see an animal&apos;s
                personality, save their favorites, and find the necessary
                information to begin the adoption process. All information about
                adoptable animals and their respective organizations is sourced
                directly from the third-party Petfinder API.
              </p>
              <p>
                You can contact us by email at{" "}
                <a href="mailto:pawdopt.co@gmail.com">pawdopt.co@gmail.com</a>{" "}
                or by mail to 1150 South Olive Street, Los Angeles, CA 90015,
                United States.
              </p>
              <p>
                These Legal Terms constitute a legally binding agreement made
                between you, whether personally or on behalf of an entity
                (&quot;you&quot;), and Pawdopt, concerning your access to and
              ...
              <p>
                We may update these Legal Terms from time to time. The updated
                version will be indicated by an updated &quot;Last updated&quot;
                date. We encourage you to review these Legal Terms frequently to
                be informed.
              </p>
              <p>
              ...
              <ol>
                ...
                <li>
                  <a href="#sitemanage">SERVICES MANAGEMENT</a>
                </li>
                <li>
                  <a href="#ppyes">PRIVACY POLICY</a>
                </li>
                <li>
                ...
                <li>
                  <a href="#addclause">RELATIONSHIP WITH PETFINDER API</a>
                </li>
                <li>
                  <a href="#addclauseb">NO GUARANTEE OF ADOPTION</a>
                </li>
                <li>
              ...
              <p>
                ...
                regulations (HIPAA, FISMA, etc.), so if your interactions would
                be subjected to such laws, you may not use the Services. You may
              ...
              <p>
                ...
                revocable license to access the Services and to download or
              ...
              <h2 id="mobile">7. MOBILE APPLICATION LICENSE</h2>
              <h3>Use License</h3>
              <p>
              ...
              <h2 id="thirdparty">8. THIRD-PARTY WEBSITES AND CONTENT</h2>
              <p>
                The Services may contain links to other websites
                (&quot;Third-Party Websites&quot;) as well as articles,
                photographs, text, graphics, and other content belonging to or
                originating from third parties (&quot;Third-Party
                Content&quot;). Such Third-Party Websites and Third-Party
                ...
                Services. If you decide to leave the Services and access the
              ...
              <p>
                ...
                discretion, violates the law or these Legal Terms; (3) in our
                sole discretion and without limitation, refuse, restrict access
                to, or limit the availability of any of your Contributions; and
                (4) otherwise manage the Services in a manner designed to
              ...
              <p>
                ...
                <Link href="/privacy-policy">
                  http://www.pawdopt.app/privacy-policy
                </Link>
                . By using the Services, you agree to be bound by our Privacy
                Policy, which is incorporated into these Legal Terms. The
                Services are hosted in the United States.
              </p>

              <hr />

              <h2 id="terms">11. TERM AND TERMINATION</h2>
              <p>
                These Legal Terms shall remain in full force and effect while
                you use the Services. WE RESERVE THE RIGHT TO, IN OUR SOLE
                DISCRETION AND WITHOUT NOTICE OR LIABILITY, DENY ACCESS TO AND
                USE OF THE SERVICES TO ANY PERSON FOR ANY REASON.
              </p>

              <hr />

              <h2 id="modifications">12. MODIFICATIONS AND INTERRUPTIONS</h2>
              <p>
              ...
              <p>
                ...
                to perform maintenance, resulting in interruptions or errors.
              ...
              <p>
                To expedite resolution and control the cost of any dispute, the
                Parties agree to first attempt to negotiate any Dispute
                informally for at least thirty (30) days before initiating
                arbitration. If the Parties are unable to resolve a Dispute
                through informal negotiations, the Dispute will be finally and
              ...
              <p>
                ...
                FORM OF THE ACTION, WILL AT ALL TIMES BE LIMITED TO $100.00 USD.
              </p>
              ...
              <p>
                ...
                warranties set forth in these Legal Terms; or (4) your violation
              ...
              <p>
                ...
                operate as a waiver of such right or provision. These Legal
                Terms operate to the fullest extent permissible by law.
              </p>

              <hr />

              <h2 id="addclause">23. RELATIONSHIP WITH PETFINDER API</h2>
              <p>
                The Pawdopt application displays information, including but not
                limited to pet profiles, images, and shelter details, sourced
                directly from the Petfinder API. Pawdopt is an independent
                application and is not affiliated with, sponsored by, or
                endorsed by Petfinder or its parent companies. We do not control
                and are not responsible for the accuracy, completeness,
                availability, or timeliness of the data provided by the
                Petfinder API. The availability of the Service is contingent
                upon the continued operation of the Petfinder API, and we
                disclaim any liability for service interruptions or data
                inaccuracies originating from this third-party source.
              </p>

              <hr />

              <h2 id="addclauseb">24. NO GUARANTEE OF ADOPTION</h2>
              <p>
                Pawdopt is a platform for discovering pets available for
                adoption and is not an adoption agency. The listing of a pet on
                our Service does not constitute an offer for adoption, nor does
                it guarantee the availability of that pet. All adoption
                processes, decisions, and agreements are handled exclusively by
                the third-party shelters and rescue organizations. We are not a
                party to any adoption and make no representations or warranties
                regarding a user&apos;s eligibility to adopt.
              </p>
