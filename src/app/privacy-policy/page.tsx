        ...
        <div className="container mx-auto px-6 py-20 text-gray-800 dark:text-gray-200">
          <div className="max-w-4xl mx-auto">
            <div className="prose prose-lg dark:prose-invert">
              ...
              <p>
                This Privacy Notice for Pawdopt (&quot;we,&quot; &quot;us,&quot;
              ...
              <ul>
                <li>
                  Download and use our mobile application (Pawdopt), or any
                  other application of ours that links to this Privacy Notice.
                </li>
                <li>
                  Use Pawdopt. Pawdopt (&quot;the App,&quot; &quot;our
                  Service&quot;) is a mobile application designed to help users
                  discover and connect with adoptable pets from shelters and
                  rescue organizations. Our Service provides a modern,
                  video-centric platform where users can browse animal profiles,
                  view videos to see an animal&apos;s personality, save their
                  favorites, and find the necessary information to begin the
                  adoption process. All information about adoptable animals and
                  their respective organizations is sourced from the Petfinder
                  API.
                </li>
                <li>
              ...
              <p>
                ...
                <a href="mailto:privacy@pawdopt.app">privacy@pawdopt.app</a>.
              </p>

              <hr />

              <h2 className="!mb-0">SUMMARY OF KEY POINTS</h2>
              <p className="!mt-2">
                <strong>
                  <em>
                    This summary provides key points from our Privacy Notice,
                    but you can find out more details about any of these topics
                    by using our <a href="#toc">table of contents</a> below to
              ...
              <p>
                ...
                <a
                  href="https://pawdopt.app/contact"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://pawdopt.app/contact
                </a>
              ...
              <ul>
                ...
                <li>
                  ...
                  (e.g., Google Maps API, Places API). We use certain Google
                  Maps Platform APIs to retrieve certain information when you
                  make location-specific requests. This includes: Geolocation
                  Data, Device and Network Information, Usage Information, and
                  other similar information. A full list of what we use
                  information for can be found in this section and in the
                  previous section titled &quot;
                  <a href="#infouse">HOW DO WE PROCESS YOUR INFORMATION?</a>
                  &quot;. You may revoke your consent anytime by contacting us
              ...
              <p>
                ...
                technologies (collectively, &quot;AI Products&quot;). These
              ...
              <p>
                ...
                (&quot;AI Service Providers&quot;), including Google Cloud AI.
                As outlined in this Privacy Notice, your input, output, and
                personal information will be shared with and processed by these
                AI Service Providers to enable your use of our AI Products for
              ...
              <ul>
                <li>
                  Use of our AI-based features is entirely optional. Users can
                  opt out of this data processing by simply choosing not to use
                  or interact with these specific features.
                </li>
              </ul>
              ...
              <p>
                ...
                information, we will either delete or anonymize it. For our app,
                this generally means that if your usage profile has been
                inactive for 24 months, we will take steps to delete or
                anonymize your associated usage data from our systems.
              </p>
              ...
              <p>
                ...
                use of the Services. If we learn that personal information from
              ...
              <p>
                ...
                communications at any time. Users can opt out of receiving these
                communications at any time by disabling push notifications for
                the Pawdopt app in their mobile device&apos;s system settings,
              ...
              <p>
                ...
                information, you have the right to submit a complaint. Please
                refer to the relevant authorities in your jurisdiction.
              </p>
              ...
              <p>
                ...
                email us at{" "}
                <a href="mailto:privacy@pawdopt.app">privacy@pawdopt.app</a> or
